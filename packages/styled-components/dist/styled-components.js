(function (global, factory) {
  ...
  const reactIs_production_min = createCommonjsModule((module, exports) => {
  Object.defineProperty(exports,"__esModule",{value:!0});
  const b=typeof Symbol==="function"&&Symbol.for; const c=b?Symbol.for("react.element"):60103; const d=b?Symbol.for("react.portal"):60106; const e=b?Symbol.for("react.fragment"):60107; const f=b?Symbol.for("react.strict_mode"):60108; const g=b?Symbol.for("react.profiler"):60114; const h=b?Symbol.for("react.provider"):60109; const k=b?Symbol.for("react.context"):60110; const l=b?Symbol.for("react.async_mode"):60111; const m=b?Symbol.for("react.concurrent_mode"):60111; const n=b?Symbol.for("react.forward_ref"):60112; const p=b?Symbol.for("react.suspense"):60113; const q=b?Symbol.for("react.memo"):
  60115; const r=b?Symbol.for("react.lazy"):60116;function t(a){if(typeof a==="object"&&a!==null){const u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m:case e:case g:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case h:return a;default:return u}}case r:case q:case d:return u}}}function v(a){return t(a)===m}exports.typeOf=t;exports.AsyncMode=l;exports.ConcurrentMode=m;exports.ContextConsumer=k;exports.ContextProvider=h;exports.Element=c;exports.ForwardRef=n;
  exports.Fragment=e;exports.Lazy=r;exports.Memo=q;exports.Portal=d;exports.Profiler=g;exports.StrictMode=f;exports.Suspense=p;exports.isValidElementType=function(a){return typeof a==="string"||typeof a==="function"||a===e||a===m||a===g||a===f||a===p||typeof a==="object"&&a!==null&&(a.$$typeof===r||a.$$typeof===q||a.$$typeof===h||a.$$typeof===k||a.$$typeof===n)};exports.isAsyncMode=function(a){return v(a)||t(a)===l};exports.isConcurrentMode=v;exports.isContextConsumer=function(a){return t(a)===k};
  exports.isContextProvider=function(a){return t(a)===h};exports.isElement=function(a){return typeof a==="object"&&a!==null&&a.$$typeof===c};exports.isForwardRef=function(a){return t(a)===n};exports.isFragment=function(a){return t(a)===e};exports.isLazy=function(a){return t(a)===r};exports.isMemo=function(a){return t(a)===q};exports.isPortal=function(a){return t(a)===d};exports.isProfiler=function(a){return t(a)===g};exports.isStrictMode=function(a){return t(a)===f};
  ...
  const reactIs_1 = reactIs.isElement;
  const reactIs_2 = reactIs.isValidElementType;
  const reactIs_3 = reactIs.ForwardRef;
  ...
  const DISABLE_SPEEDY = typeof SC_DISABLE_SPEEDY === 'boolean' && SC_DISABLE_SPEEDY || "development" !== 'production';
  ...
  const StyledComponentsError = function (_Error) {
    ...
    function StyledComponentsError(code) {
      ...
      if (false) {
        ...
        var _this = possibleConstructorReturn(this, _Error.call(this, format(...[ERRORS[code]].concat(interpolations)).trim()));
      }
...
const matchIndex = _ref.matchIndex;
  ...
  const stylis_min = createCommonjsModule((module, exports) => {
  !function(e){module.exports=e(null);}(function e(a){const r=/^\0+/g; const c=/[\0\r\f]/g; const s=/: */g; const t=/zoo|gra/; const i=/([,: ])(transform)/g; const f=/,+\s*(?![^(]*[)])/g; const n=/ +\s*(?![^(]*[)])/g; const l=/ *[\0] */g; const o=/,\r+?/g; const h=/([\t\r\n ])*\f?&/g; const u=/:global\(((?:[^\(\)\[\]]*|\[.*\]|\([^\(\)]*\))*)\)/g; const d=/\W+/g; const b=/@(k\w+)\s*(\S*)\s*/; const p=/::(place)/g; const k=/:(read-only)/g; const g=/\s+(?=[{\];=:>])/g; const A=/([[}=:>])\s+/g; const C=/(\{[^{]+?);(?=\})/g; const w=/\s{2,}/g; const v=/([^\(])(:+) */g; const m=/[svh]\w+-[tblr]{2}/; const x=/\(\s*(.*)\s*\)/g; const $=/([\s\S]*?);/g; const y=/-self|flex-/g; const O=/[^]*?(:[rp][el]a[\w-]+)[^]*/; const j=/stretch|:\s*\w+\-(?:conte|avail)/; const z=/([^-])(image-set\()/; const N="-webkit-"; const S="-moz-"; const F="-ms-"; const W=59; const q=125; const B=123; const D=40; const E=41; const G=91; const H=93; const I=10; const J=13; const K=9; const L=64; const M=32; const P=38; const Q=45; const R=95; const T=42; const U=44; const V=58; const X=39; const Y=34; const Z=47; const _=62; const ee=43; const ae=126; const re=0; const ce=12; const se=11; const te=107; const ie=109; const fe=115; const ne=112; const le=111; const oe=105; const he=99; const ue=100; const de=112; let be=1; let pe=1; let ke=0; let ge=1; let Ae=1; let Ce=1; let we=0; let ve=0; let me=0; const xe=[]; const $e=[]; let ye=0; let Oe=null; const je=-2; const ze=-1; const Ne=0; const Se=1; const Fe=2; const We=3; let qe=0; let Be=1; let De=""; let Ee=""; let Ge="";function He(e,a,s,t,i){for(var f,n,o=0,h=0,u=0,d=0,g=0,A=0,C=0,w=0,m=0,$=0,y=0,O=0,j=0,z=0,R=0,we=0,$e=0,Oe=0,je=0,ze=s.length,Je=ze-1,Re="",Te="",Ue="",Ve="",Xe="",Ye="";R<ze;){if(C=s.charCodeAt(R),R===Je)if(h+d+u+o!==0){if(h!==0)C=h===Z?I:Z;d=u=o=0,ze++,Je++;}if(h+d+u+o===0){if(R===Je){if(we>0)Te=Te.replace(c,"");if(Te.trim().length>0){switch(C){case M:case K:case W:case J:case I:break;default:Te+=s.charAt(R);}C=W;}}if($e===1)switch(C){case B:case q:case W:case Y:case X:case D:case E:case U:$e=0;case K:case J:case I:case M:break;default:for($e=0,je=R,g=C,R--,C=W;je<ze;)switch(s.charCodeAt(je++)){case I:case J:case W:++R,C=g,je=ze;break;case V:if(we>0)++R,C=g;case B:je=ze;}}switch(C){case B:for(g=(Te=Te.trim()).charCodeAt(0),y=1,je=++R;R<ze;){switch(C=s.charCodeAt(R)){case B:y++;break;case q:y--;break;case Z:switch(A=s.charCodeAt(R+1)){case T:case Z:R=Qe(A,R,Je,s);}break;case G:C++;case D:C++;case Y:case X:for(;R++<Je&&s.charCodeAt(R)!==C;);}if(y===0)break;R++;}if(Ue=s.substring(je,R),g===re)g=(Te=Te.replace(r,"").trim()).charCodeAt(0);switch(g){case L:if(we>0)Te=Te.replace(c,"");switch(A=Te.charCodeAt(1)){case ue:case ie:case fe:case Q:f=a;break;default:f=xe;}if(je=(Ue=He(a,f,Ue,A,i+1)).length,me>0&&je===0)je=Te.length;if(ye>0)if(f=Ie(xe,Te,Oe),n=Pe(We,Ue,f,a,pe,be,je,A,i,t),Te=f.join(""),void 0!==n)if((je=(Ue=n.trim()).length)===0)A=0,Ue="";if(je>0)switch(A){case fe:Te=Te.replace(x,Me);case ue:case ie:case Q:Ue=`${Te}{${Ue}}`;break;case te:if(Ue=`${Te=Te.replace(b,`$1 $2${Be>0?De:""}`)}{${Ue}}`,Ae===1||Ae===2&&Le(`@${Ue}`,3))Ue=`@${N}${Ue}@${Ue}`;else Ue=`@${Ue}`;break;default:if(Ue=Te+Ue,t===de)Ve+=Ue,Ue="";}else Ue="";break;default:Ue=He(a,Ie(a,Te,Oe),Ue,t,i+1);}Xe+=Ue,O=0,$e=0,z=0,we=0,Oe=0,j=0,Te="",Ue="",C=s.charCodeAt(++R);break;case q:case W:if((je=(Te=(we>0?Te.replace(c,""):Te).trim()).length)>1){if(z===0)if((g=Te.charCodeAt(0))===Q||g>96&&g<123)je=(Te=Te.replace(" ",":")).length;if(ye>0)if(void 0!==(n=Pe(Se,Te,a,e,pe,be,Ve.length,t,i,t)))if((je=(Te=n.trim()).length)===0)Te="\0\0";switch(g=Te.charCodeAt(0),A=Te.charCodeAt(1),g){case re:break;case L:if(A===oe||A===he){Ye+=Te+s.charAt(R);break}default:if(Te.charCodeAt(je-1)===V)break;Ve+=Ke(Te,g,A,Te.charCodeAt(2));}}O=0,$e=0,z=0,we=0,Oe=0,Te="",C=s.charCodeAt(++R);}}switch(C){case J:case I:if(h+d+u+o+ve===0)switch($){case E:case X:case Y:case L:case ae:case _:case T:case ee:case Z:case Q:case V:case U:case W:case B:case q:break;default:if(z>0)$e=1;}if(h===Z)h=0;else if(ge+O===0&&t!==te&&Te.length>0)we=1,Te+="\0";if(ye*qe>0)Pe(Ne,Te,a,e,pe,be,Ve.length,t,i,t);be=1,pe++;break;case W:case q:if(h+d+u+o===0){be++;break}default:switch(be++,Re=s.charAt(R),C){case K:case M:if(d+o+h===0)switch(w){case U:case V:case K:case M:Re="";break;default:if(C!==M)Re=" ";}break;case re:Re="\\0";break;case ce:Re="\\f";break;case se:Re="\\v";break;case P:if(d+h+o===0&&ge>0)Oe=1,we=1,Re=`\f${Re}`;break;case 108:if(d+h+o+ke===0&&z>0)switch(R-z){case 2:if(w===ne&&s.charCodeAt(R-3)===V)ke=w;case 8:if(m===le)ke=m;}break;case V:if(d+h+o===0)z=R;break;case U:if(h+u+d+o===0)we=1,Re+="\r";break;case Y:case X:if(h===0)d=d===C?0:d===0?C:d;break;case G:if(d+h+u===0)o++;break;case H:if(d+h+u===0)o--;break;case E:if(d+h+o===0)u--;break;case D:if(d+h+o===0){if(O===0)switch(2*w+3*m){case 533:break;default:y=0,O=1;}u++;}break;case L:if(h+u+d+o+z+j===0)j=1;break;case T:case Z:if(d+o+u>0)break;switch(h){case 0:switch(2*C+3*s.charCodeAt(R+1)){case 235:h=Z;break;case 220:je=R,h=T;}break;case T:if(C===Z&&w===T&&je+2!==R){if(s.charCodeAt(je+2)===33)Ve+=s.substring(je,R+1);Re="",h=0;}}}if(h===0){if(ge+d+o+j===0&&t!==te&&C!==W)switch(C){case U:case ae:case _:case ee:case E:case D:if(O===0){switch(w){case K:case M:case I:case J:Re+="\0";break;default:Re=`\0${Re}${C===U?"":"\0"}`;}we=1;}else switch(C){case D:if(z+7===R&&w===108)z=0;O=++y;break;case E:if((O=--y)==0)we=1,Re+="\0";}break;case K:case M:switch(w){case re:case B:case q:case W:case U:case ce:case K:case M:case I:case J:break;default:if(O===0)we=1,Re+="\0";}}if(Te+=Re,C!==M&&C!==K)$=C;}}m=w,w=C,R++;}if(je=Ve.length,me>0)if(je===0&&Xe.length===0&&a[0].length===0==false)if(t!==ie||a.length===1&&(ge>0?Ee:Ge)===a[0])je=a.join(",").length+2;if(je>0){if(f=ge===0&&t!==te?function(e){for(var a,r,s=0,t=e.length,i=Array(t);s<t;++s){for(var f=e[s].split(l),n="",o=0,h=0,u=0,d=0,b=f.length;o<b;++o){if((h=(r=f[o]).length)===0&&b>1)continue;if(u=n.charCodeAt(n.length-1),d=r.charCodeAt(0),a="",o!==0)switch(u){case T:case ae:case _:case ee:case M:case D:break;default:a=" ";}switch(d){case P:r=a+Ee;case ae:case _:case ee:case M:case E:case D:break;case G:r=a+r+Ee;break;case V:switch(2*r.charCodeAt(1)+3*r.charCodeAt(2)){case 530:if(Ce>0){r=a+r.substring(8,h-1);break}default:if(o<1||f[o-1].length<1)r=a+Ee+r;}break;case U:a="";default:if(h>1&&r.indexOf(":")>0)r=a+r.replace(v,`$1${Ee}$2`);else r=a+r+Ee;}n+=r;}i[s]=n.replace(c,"").trim();}return i}(a):a,ye>0)if(void 0!==(n=Pe(Fe,Ve,f,e,pe,be,je,t,i,t))&&(Ve=n).length===0)return Ye+Ve+Xe;if(Ve=`${f.join(",")}{${Ve}}`,Ae*ke!=0){if(Ae===2&&!Le(Ve,2))ke=0;switch(ke){case le:Ve=Ve.replace(k,`:${S}$1`)+Ve;break;case ne:Ve=Ve.replace(p,`::${N}input-$1`)+Ve.replace(p,`::${S}$1`)+Ve.replace(p,`:${F}input-$1`)+Ve;}ke=0;}}return Ye+Ve+Xe}function Ie(e,a,r){const c=a.trim().split(o); let s=c; const t=c.length; const i=e.length;switch(i){case 0:case 1:for(var f=0,n=i===0?"":`${e[0]} `;f<t;++f)s[f]=Je(n,s[f],r,i).trim();break;default:f=0;var l=0;for(s=[];f<t;++f)for(let h=0;h<i;++h)s[l++]=Je(`${e[h]} `,c[f],r,i).trim();}return s}function Je(e,a,r,c){let s=a; let t=s.charCodeAt(0);if(t<33)t=(s=s.trim()).charCodeAt(0);switch(t){case P:switch(ge+c){case 0:case 1:if(e.trim().length===0)break;default:return s.replace(h,`$1${e.trim()}`)}break;case V:switch(s.charCodeAt(1)){case 103:if(Ce>0&&ge>0)return s.replace(u,"$1").replace(h,`$1${Ge}`);break;default:return e.trim()+s.replace(h,`$1${e.trim()}`)}default:if(r*ge>0&&s.indexOf("\f")>0)return s.replace(h,(e.charCodeAt(0)===V?"":"$1")+e.trim())}return e+s}function Ke(e,a,r,c){let l; let o=0; let h=`${e};`; let u=2*a+3*r+4*c;if(u===944)return function(e){var a=e.length; var r=e.indexOf(":",9)+1; const c=e.substring(0,r).trim(); let s=e.substring(r,a-1).trim();switch(e.charCodeAt(9)*Be){case 0:break;case Q:if(e.charCodeAt(10)!==110)break;default:for(var t=s.split((s="",f)),i=0,r=0,a=t.length;i<a;r=0,++i){for(var l=t[i],o=l.split(n);l=o[r];){const h=l.charCodeAt(0);if(Be===1&&(h>L&&h<90||h>96&&h<123||h===R||h===Q&&l.charCodeAt(1)!==Q))switch(isNaN(parseFloat(l))+(l.indexOf("(")!==-1)){case 1:switch(l){case"infinite":case"alternate":case"backwards":case"running":case"normal":case"forwards":case"both":case"none":case"linear":case"ease":case"ease-in":case"ease-out":case"ease-in-out":case"paused":case"reverse":case"alternate-reverse":case"inherit":case"initial":case"unset":case"step-start":case"step-end":break;default:l+=De;}}o[r++]=l;}s+=(i===0?"":",")+o.join(" ");}}if(s=`${c+s};`,Ae===1||Ae===2&&Le(s,1))return N+s+s;return s}(h);else if(Ae===0||Ae===2&&!Le(h,1))return h;switch(u){case 1015:return h.charCodeAt(10)===97?N+h+h:h;case 951:return h.charCodeAt(3)===116?N+h+h:h;case 963:return h.charCodeAt(5)===110?N+h+h:h;case 1009:if(h.charCodeAt(4)!==100)break;case 969:case 942:return N+h+h;case 978:return N+h+S+h+h;case 1019:case 983:return N+h+S+h+F+h+h;case 883:if(h.charCodeAt(8)===Q)return N+h+h;if(h.indexOf("image-set(",11)>0)return h.replace(z,`$1${N}$2`)+h;return h;case 932:if(h.charCodeAt(4)===Q)switch(h.charCodeAt(5)){case 103:return `${N}box-${h.replace("-grow","")}${N}${h}${F}${h.replace("grow","positive")}${h}`;case 115:return N+h+F+h.replace("shrink","negative")+h;case 98:return N+h+F+h.replace("basis","preferred-size")+h}return N+h+F+h+h;case 964:return `${N+h+F}flex-${h}${h}`;case 1023:if(h.charCodeAt(8)!==99)break;return l=h.substring(h.indexOf(":",15)).replace("flex-","").replace("space-between","justify"),`${N}box-pack${l}${N}${h}${F}flex-pack${l}${h}`;case 1005:return t.test(h)?h.replace(s,`:${N}`)+h.replace(s,`:${S}`)+h:h;case 1e3:switch(o=(l=h.substring(13).trim()).indexOf("-")+1,l.charCodeAt(0)+l.charCodeAt(o)){case 226:l=h.replace(m,"tb");break;case 232:l=h.replace(m,"tb-rl");break;case 220:l=h.replace(m,"lr");break;default:return h}return N+h+F+l+h;case 1017:if(h.indexOf("sticky",9)===-1)return h;case 975:switch(o=(h=e).length-10,u=(l=(h.charCodeAt(o)===33?h.substring(0,o):h).substring(e.indexOf(":",7)+1).trim()).charCodeAt(0)+(0|l.charCodeAt(7))){case 203:if(l.charCodeAt(8)<111)break;case 115:h=`${h.replace(l,N+l)};${h}`;break;case 207:case 102:h=`${h.replace(l,`${N+(u>102?"inline-":"")}box`)};${h.replace(l,N+l)};${h.replace(l,`${F+l}box`)};${h}`;}return `${h};`;case 938:if(h.charCodeAt(5)===Q)switch(h.charCodeAt(6)){case 105:return l=h.replace("-items",""),`${N+h+N}box-${l}${F}flex-${l}${h}`;case 115:return `${N+h+F}flex-item-${h.replace(y,"")}${h}`;default:return `${N+h+F}flex-line-pack${h.replace("align-content","").replace(y,"")}${h}`}break;case 973:case 989:if(h.charCodeAt(3)!==Q||h.charCodeAt(4)===122)break;case 931:case 953:if(j.test(e)===true)if((l=e.substring(e.indexOf(":")+1)).charCodeAt(0)===115)return Ke(e.replace("stretch","fill-available"),a,r,c).replace(":fill-available",":stretch");else return h.replace(l,N+l)+h.replace(l,S+l.replace("fill-",""))+h;break;case 962:if(h=N+h+(h.charCodeAt(5)===102?F+h:"")+h,r+c===211&&h.charCodeAt(13)===105&&h.indexOf("transform",10)>0)return h.substring(0,h.indexOf(";",27)+1).replace(i,`$1${N}$2`)+h}return h}function Le(e,a){const r=e.indexOf(a===1?":":"{"); const c=e.substring(0,a!==3?r:10); const s=e.substring(r+1,e.length-1);return Oe(a!==2?c:c.replace(O,"$1"),s,a)}function Me(e,a){const r=Ke(a,a.charCodeAt(0),a.charCodeAt(1),a.charCodeAt(2));return r!==`${a};`?r.replace($," or ($1)").substring(4):`(${a})`}function Pe(e,a,r,c,s,t,i,f,n,l){for(var o,h=0,u=a;h<ye;++h)switch(o=$e[h].call(Te,e,u,r,c,s,t,i,f,n,l)){case void 0:case false:case true:case null:break;default:u=o;}if(u!==a)return u}function Qe(e,a,r,c){for(var s=a+1;s<r;++s)switch(c.charCodeAt(s)){case Z:if(e===T)if(c.charCodeAt(s-1)===T&&a+2!==s)return s+1;break;case I:if(e===Z)return s+1}return s}function Re(e){for(const a in e){const r=e[a];switch(a){case"keyframe":Be=0|r;break;case"global":Ce=0|r;break;case"cascade":ge=0|r;break;case"compress":we=0|r;break;case"semicolon":ve=0|r;break;case"preserve":me=0|r;break;case"prefix":if(Oe=null,!r)Ae=0;else if(typeof r!=="function")Ae=1;else Ae=2,Oe=r;}}return Re}function Te(a,r){if(void 0!==this&&this.constructor===Te)return e(a);let s=a; let t=s.charCodeAt(0);if(t<33)t=(s=s.trim()).charCodeAt(0);if(Be>0)De=s.replace(d,t===G?"":"-");if(t=1,ge===1)Ge=s;else Ee=s;let i; const f=[Ge];if(ye>0)if(void 0!==(i=Pe(ze,r,f,f,pe,be,0,0,0,0))&&typeof i==="string")r=i;let n=He(xe,f,r,0,0);if(ye>0)if(void 0!==(i=Pe(je,n,f,f,pe,be,n.length,0,0,0))&&typeof(n=i)!=="string")t=0;return De="",Ge="",Ee="",ke=0,pe=1,be=1,we*t==0?n:n.replace(c,"").replace(g,"").replace(A,"$1").replace(C,"$1").replace(w," ")}if(Te.use=function e(a){switch(a){case void 0:case null:ye=$e.length=0;break;default:if(typeof a==="function")$e[ye++]=a;else if(typeof a==="object")for(let r=0,c=a.length;r<c;++r)e(a[r]);else qe=0|!!a;}return e},Te.set=Re,void 0!==a)Re(a);return Te});

  });

  const stylisRuleSheet = createCommonjsModule((module, exports) => {
  (function (factory) {
  ...
  const stylisSplitter = new stylis_min({
    global: false,
    cascade: true,
    keyframe: false,
    prefix: false,
  ...
  const parseRulesPlugin = stylisRuleSheet((rule) => {
...
const cssRules = _sheetForTag.cssRules;
...
const cssFromDOM = _extracted$i.cssFromDOM;
  ...
  const StyleSheet = function () {
    ...
    StyleSheet.prototype.toReactElements = function toReactElements() {
      ...
      return this.tags.map((tag, i) => {
        const key = `sc-${  id  }-${  i}`;
        return React.cloneElement(tag.toElement(), { key });
      });
    };
  ...
  function flatten(chunk, executionContext, styleSheet) {
    if (Array.isArray(chunk)) {
      ...
      for (var i = 0, len = chunk.length, result; i < len; i += 1) {
        ...
        if (result === null) continue;else if (Array.isArray(result)) ruleSet.push(...result);else ruleSet.push(result);
      }
  ...
  */
  ...
  const simpleIsEqual = function simpleIsEqual(newArgs, lastArgs) {
    return newArgs.length === lastArgs.length && newArgs.every((newArg, index) => shallowEqual(newArg, lastArgs[index]));
  };
  ...
  const ServerStyleSheet = function () {
    ...
    ServerStyleSheet.prototype.interleaveWithNodeStream = function interleaveWithNodeStream(readableStream) {
      ...
      readableStream.on('end', () => _this.seal());
...
const globalStyle = _this$constructor.globalStyle;

            
const styledComponentId = _this$constructor.styledComponentId;
      ...
      GlobalStyleComponent.prototype.render = function render() {
        ...
        return React__default.createElement(
          ...
          (styleSheet) => {
            ...
            const globalStyle = _this2.state.globalStyle;
            ...
            if (globalStyle.isStatic) {
              ...
              return React__default.createElement(
                ...
                (theme) => {
                  // $FlowFixMe
                  const defaultProps = _this2.constructor.defaultProps;
  ...
  const TYPE_STATICS = (_TYPE_STATICS = {}, _TYPE_STATICS[reactIs_3] = {
    $$typeof: true,
    render: true
  }, _TYPE_STATICS);
...
const getOwnPropertySymbols$1 = _Object$getOwnPropert === undefined ? function () {
    return [];
...
const objectPrototype = Object.prototype;
  ...
  const withTheme = (function (Component) {
    const WithTheme = React__default.forwardRef((props, ref) => React__default.createElement(
        ThemeConsumer,
        null,
        (theme) => {
          // $FlowFixMe
          ...
          return React__default.createElement(Component, _extends({}, props, { theme: themeProp, ref }));
        }
      ));
...
const warnTooManyClasses = _props$forwardedCompo2.warnTooManyClasses;
...
const attrs = _options$attrs === undefined ? EMPTY_ARRAY : _options$attrs;
    ...
    const ParentStyledComponent = function (_StyledComponent) {
      inherits(ParentStyledComponent, _StyledComponent);

      function ParentStyledComponent() {
        classCallCheck(this, ParentStyledComponent);
        return possibleConstructorReturn(this, _StyledComponent.apply(this, arguments));
      }

      return ParentStyledComponent;
    }(StyledComponent);

    ParentStyledComponent.displayName = `StyledComponent(${  displayName  })`;
    const _options$ParentCompon = options.ParentComponent;

        
const ParentComponent = _options$ParentCompon === undefined ? ParentStyledComponent : _options$ParentCompon;
    ...
    const ForwardRef = function ForwardRef(props, ref) {
      return React__default.createElement(ParentStyledComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
    };
