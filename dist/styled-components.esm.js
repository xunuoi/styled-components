...
const ParentComponent = _options$ParentCompon === undefined ? ParentStyledComponent : _options$ParentCompon;
  ...
  const ForwardRef$$1 = function ForwardRef$$1(props, ref) {
    return React.createElement(ParentStyledComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  // Assign the `displayName` to ForwardRef to get the correct `ForwardRef(displayName)` in snapshots
  ForwardRef$$1.displayName = displayName;
  WrappedStyledComponent = React.forwardRef(ForwardRef$$1);
  // $FlowFixMe
...
const withTheme = (function (Component$$1) {
  const WithTheme = React.forwardRef((props, ref) => React.createElement(
      ...
      (theme) => {
        // $FlowFixMe
        const defaultProps = Component$$1.defaultProps;
